        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/comgahouston_ks/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary transition-colors">
              ...
              <a href="https://www.tiktok.com/@comgakansas" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/#specials" className="text-white/70 hover:text-primary transition-colors">Lunch Specials</Link></li>
              <li><Link href="/#menu" className="text-white/70 hover:text-primary transition-colors">Our Menu</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:9132328306" className="hover:text-primary transition-colors">(913) 232-8306</a>
              </li>
            </ul>
          </div>
        </div>
